...
internal class TouchGestures(private val observer: TouchGesturesObserver) {
    ...
    companion object {
        ...
        // === AnimeStream: lower value = less sensitive (requires deliberate swipe) ===
        private const val CONTROL_VOLUME_MAX = 0.8f
        ...
        // === AnimeStream: higher value = more sensitive (small swipe gives big change) ===
        private const val CONTROL_BRIGHT_MAX = 2.5f
