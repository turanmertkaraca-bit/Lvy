...
object MPVLib {
    ...
    // === AnimeStream: track whether mpv has been created/destroyed ===
    @Volatile
    private var created: Boolean = false

    /** True if mpv has been initialized and not yet destroyed. */
    @JvmStatic
    fun isCreated(): Boolean = created

    /** Called by BaseMPVView.initialize() after create() succeeds. */
    internal fun markCreated() { created = true }

    /** Called by BaseMPVView.destroy() before destroy() is invoked. */
    internal fun markDestroyed() { created = false }
